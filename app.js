...
//    for(var row of multiArray){
//    var rowString= row.join(" ");
  
//    document.write(`<h1>${rowString}</h1>`)
//    }
...
// }
// // 8. Find a largest number of array
// var arr = [2,4,6];
// var largest = arr[0];
...
//     }
// }
// document.write(`<h1>Array Item ${arr}</h1>`);
// document.write(`<h1>Larget number of arry = ${largest}</h1>`);

// // 9. Find a smalest number of array
// var arr = [2,4,6];
// var largest = arr[0];
// for(i = 0; i < arr.length; i++){
//     if(arr[i] < largest){
...
// }
// document.write(`<h1>Array Item ${arr}</h1>`);
// document.write(`<h1>Smallest number of arry = ${largest}</h1>`);
